                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="single-main">
                                ...
                                <!-- News Title -->
                                <h1 class="news-title"><a href="news-single.php">More than 80 clinical trials launch to
                                        test of the coronavirus .</a></h1>
                                <!-- Meta -->
                                <div class="meta">
                                    <div class="meta-left">
                                        <span class="author"><a href="#"><img src="img/author1.jpg" alt="#">Naimur
                                                Rahman</a></span>
