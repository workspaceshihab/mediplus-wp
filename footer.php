        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-3 col-md-6 col-12">
                    ...
                    // echo get_cat_name($options['opt-select-13']);
                    
                    foreach($options['social'] as $single_value){
                        
                       ?>
                            <li><a href="<?php echo $single_value['option_link'];?>"><i
                                        class="<?php echo $single_value['option_icon'];?>"></i></a></li>
                            <?php
                            }
